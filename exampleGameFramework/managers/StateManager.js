...
export default class StateManagerClass {
   ...
   setState1 = (variable1) => {
      ...
      //set ui elements
      this.uiManager1.setActive("button1");
   ...
   setState2 = (variable1) => {
      ...
      //set ui elements
      this.uiManager1.setInactive("button2");
   ...
   setState3 = (variable1, variable2, variable3, variable4) => {
      ...
      //set ui elements
      this.uiManager.setDisabled("button1");
      this.uiManager.setDisabled("button2");
